...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Выполняем полную замену электрики, установку и подключение любых электроприборов. Предоставляем бесплатный выезд мастера и консультацию, а также официальную гарантию на все работы до 3 лет.'
    },
    {
      number: '03',
      title: 'Честные цены',
